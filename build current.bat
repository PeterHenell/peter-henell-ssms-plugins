...
call "C:\Windows\Microsoft.NET\assembly\GAC_64\MSBuild\v4.0_12.0.0.0__b03f5f7f11d50a3a\MSBuild.exe" MSSQLDataSetTools\DataSetComparer\DataSetTools.csproj /t:Build /p:Configuration=Debug
